...
Release notes live on the [GitHub Releases](https://github.com/galax-io/galaxio-cli/releases)
page, generated by GoReleaser from Conventional Commits at tag time. There is
no `CHANGELOG.md` in this repository.
