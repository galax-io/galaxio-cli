...
- [ ] T007 [US4] Add repeatability, custom option, empty-outcome and selected-only inventory regressions in `cmd/galaxio/report_export_test.go` and `internal/report/legacy/legacy_test.go`
