...
- [X] T003 Convert `.github/workflows/ci.yml` to verification-only CI.
- [X] T004 Add tag-triggered `.github/workflows/release.yml` with linkage,
  verification, GitHub Release, and Docker publication stages.
- [X] T005 Amend `AGENTS.md` and the constitution to the shared release process.
- [X] T006 Run the regression suite, shell suites, Go verification, workflow
